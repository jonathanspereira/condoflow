    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/condominiums/me").hasAuthority("SINDICO")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/condominiums/*/focus-mode").hasAuthority("SINDICO")
                        .requestMatchers(HttpMethod.GET, "/api/v1/condominiums/*/concierges").hasAnyAuthority("SUPER_ADMIN", "SINDICO")

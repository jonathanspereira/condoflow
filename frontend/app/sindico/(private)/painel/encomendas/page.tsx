    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button onClick={() => router.push("/sindico/painel/encomendas/novo")} className="gap-2">
            <Plus className="h-4 w-4" />
            Receber Pacote
          </Button>
          <Button onClick={() => router.push("/sindico/painel/encomendas/leitor")} variant="secondary" className="gap-2">
